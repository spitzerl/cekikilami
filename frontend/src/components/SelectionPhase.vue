        ...
        <div class="flex flex-wrap gap-3">
          <div v-for="player in store.players" :key="player.id" class="flex items-center gap-3 bg-slate-900/60 border border-slate-800 rounded-xl px-4 py-2 hover:bg-slate-800/60 transition-colors">
            <div class="flex items-center gap-2">
              ...
              <img v-if="player.avatar_seed" :src="`https://api.dicebear.com/9.x/notionists-neutral/svg?seed=${player.avatar_seed}&backgroundColor=06b6d4,9333ea,f59e0b,f43f5e,10b981,3b82f6,6366f1`" class="w-6 h-6 rounded-full border border-slate-700/50 bg-slate-800/80 -ml-0.5" alt="Avatar" />
